...
#Import the datamodel classes
from models import Book, BookUpdate


router = APIRouter()

# End-point Method to save new book information to library
...
# End-point Method to GET (all) books information from library
...
# End-point Method to GET (one) a specific book by id from library
...
# End-point Method to UPDATE a specific book by id in the library
...
# End-point Method to DELETE a specific book by id in the library
